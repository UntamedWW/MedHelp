...
namespace Medhelp.PersistenceLayer.Migrations
{
    ...
    [Migration("20250525161323_ParsedElementsCounter")]
    partial class ParsedElementsCounter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiseaseGroupMedicine", b =>
                {
                    b.Property<Guid>("DiseaseGroupsId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("MedicinesId")
                        .HasColumnType("uuid");

                    b.HasKey("DiseaseGroupsId", "MedicinesId");

                    b.HasIndex("MedicinesId");

                    b.ToTable("DiseaseGroupMedicine");
                });
            ...
            modelBuilder.Entity("Medhelp.Domain.Entities.ParsedElementsCounter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("LastElementNumber")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ParsedElementsCounters");
                });
            ...
            modelBuilder.Entity("DiseaseGroupMedicine", b =>
                {
                    b.HasOne("Medhelp.Domain.Entities.DiseaseGroup", null)
                        .WithMany()
                        .HasForeignKey("DiseaseGroupsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
